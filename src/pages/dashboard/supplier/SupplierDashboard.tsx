...
const SupplierDashboard = () => {
  ...
  // const { data: supplierPaymentsData } = useGetSupplierPaymentsQuery(supplierId!, {
  //   skip: !supplierId
  // });
  // const { data: supplierProductsData } = useGetSupplierProductsQuery(supplierId!, {
  //   skip: !supplierId
  // });
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatsCard
            ...
            change={`${
              supplierPayments.filter((p: any) => p.status === "pending").length
            } pending`}
            changeType="negative"
            icon={Clock}
          />
